...
fn unsorted_single() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/single/unsorted.json"))
        .dispatch();
...
fn duplicate_single() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/single/duplicate.json"))
        .dispatch();
...
fn oob_less_single() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/single/oob_less.json"))
        .dispatch();
...
fn oob_more_single() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/single/oob_more.json"))
        .dispatch();
...
fn unsorted_range() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/range/unsorted.json"))
        .dispatch();
...
fn duplicate_range() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/range/duplicate.json"))
        .dispatch();
...
fn oob_less_range() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/range/oob_less.json"))
        .dispatch();
...
fn oob_more_range() {
    ...
    let mut res = client
        .put("/table/test")
        .header(ContentType::JSON)
        .body(include_str!("../../test_data/server/errors/range/oob_more.json"))
        .dispatch();
