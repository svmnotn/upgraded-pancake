...
const TEST_VALUES: [&str; 20] = [
    ...
    include_str!("../../../test_data/errors/range/duplicate.json"),
    include_str!("../../../test_data/errors/range/oob_less.json"),
    include_str!("../../../test_data/errors/range/oob_more.json"),
    include_str!("../../../test_data/errors/range/unsorted.json"),
    include_str!("../../../test_data/errors/single/duplicate.json"),
    include_str!("../../../test_data/errors/single/oob_less.json"),
    include_str!("../../../test_data/errors/single/oob_more.json"),
    include_str!("../../../test_data/errors/single/unsorted.json"),
];
